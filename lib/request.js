...
class WebsocketRequest extends EventEmitter {
	constructor(req, message) {
		...
		util.definePropertyFixed(this, 'headers', requestHeaders.requestHeadersFactory(req, message));
		...
		util.definePropertyFixed(this, 'rawHeaders', requestHeaders.rawHeadersFactory(req, message));
